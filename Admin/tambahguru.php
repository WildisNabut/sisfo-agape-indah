      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h4 class="modal-title" id="modalKelasLabel"> Form Tambah Guru</h3>
...
<div class="container-fluid">
    <form method="POST" action="tguru.php">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputnisn" name="nip">
            </div>
        </div>
    ...
    <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="inputtanggallahir" class="col-sm-2 col-form-label">No Telpon</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputtanggallahir" name="tlpn">
            </div>
        </div>
