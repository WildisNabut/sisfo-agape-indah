      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h4 class="modal-title" id="modalKelasLabel"> Form Tambah Kelas</h3>
          ...
          <form method="POST" action="tkelas.php" >
                <div class="form-group row">
                    <label for="inpunamakelas" class="col-sm-2 col-form-label">Nama Kelas</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputnamakelas" name="nama_kelas">
                    </div>
                </div>
