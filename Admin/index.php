...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h4 class="modal-title" id="modalKelasLabel"> Dashboard Admin</h3>
            <!-- Topbar Navbar -->
          ...
          <div class="container-fluid">
            ...
            $jml_guru = $row['total']; // Menyimpan jumlah kelas
            ?>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jml_guru; ?></div> <!-- Menampilkan jumlah kelas -->
                            </div>
                            <div class="col-auto">
                        ...
                        <!-- Tombol More -->
                        <a href="guru.php" class="btn btn-primary mt-3">
                      ...
                      <div class="card-body">
                          <div class="row no-gutters align-items-center">
                              <div class="col mr-2">
                                  ...
                                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jml_siswa; ?></div> <!-- Menampilkan jumlah kelas -->
                              </div>
                              <div class="col-auto">
                          ...
                          <!-- Tombol More -->
                          <a href="siswa.php" class="btn btn-primary mt-3">
                              <i class="fas fa-arrow-right"></i> Lihat
                          </a>
                      </div>
                  </div>
                      ...
                      <div class="card-body">
                          <div class="row no-gutters align-items-center">
                              <div class="col mr-2">
                                  ...
                                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jml_kelas; ?></div> <!-- Menampilkan jumlah kelas -->
                              </div>
                              <div class="col-auto">
                          ...
                          <!-- Tombol More -->
                          <a href="kelas.php" class="btn btn-primary mt-3">
                              <i class="fas fa-arrow-right"></i> Lihat
                          </a>
                      </div>
                  </div>
