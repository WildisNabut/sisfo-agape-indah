...
<html lang="id">
  ...
  <body>
    ...
    <div class="container">
      <section>
        <h2>Visi dan Misi</h2>
        <p><strong>Visi:</strong> Menjadi sekolah unggul yang mengintegrasikan iman dan ilmu pengetahuan.</p>
        <p><strong>Misi:</strong></p>
        <ul>
          <li>Mendidik siswa dengan kurikulum yang berstandar nasional.</li>
          <li>Mengembangkan karakter yang baik sesuai nilai-nilai Kristen.</li>
        </ul>
      </section>

      <section>
        <h2>Sejarah</h2>
        <p>Didirikan pada tahun XXXX, SMP Agape Indah berkomitmen untuk memberikan pendidikan yang berkualitas dan berkarakter.</p>
      </section>
    </div>
